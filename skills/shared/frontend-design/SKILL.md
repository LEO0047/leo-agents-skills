...
## Local delivery quality gate

For implementation work, read and follow [QUALITY_GATE.md](QUALITY_GATE.md). It supplements this official skill with the user's visual acceptance and evidence requirements.
